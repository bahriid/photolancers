                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="banner-hero banner-image-single"><img
                                    src="{{asset('assets/imgs/page/job-single/thumb.png')}}" alt="jobBox"></div>
                        </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="job-overview">
                            ...
                            <div class="row mt-25">
                                ...
                                <div class="col-md-6 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10"><span
                                            class="text-description mb-10">Deadline</span><strong class="small-heading">10/08/2022</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-25">
                                ...
                                <div class="col-md-6 d-flex mt-sm-15">
                                    ...
                                    <div class="sidebar-text-info ml-10"><span
                                            ...
                                            Texas Remote Friendly</strong></div>
                                </div>
                            </div>
                        </div>
                        <div class="content-single">
                            ...
                            <p>
                                ...
                                demonstrates their passion for illustrative design and typography. This candidate will
                                have experiences in working with numerous different design platforms such as digital
                                and print forms.
                            </p>
                            ...
                            <p><strong>Product knowledge:</strong> Deeply understand the technology and features of the
                                product area to which you are assigned.</p>
                            <p><strong>Research:</strong> Provide human and business impact and insights for products.
                            </p>
                            <p><strong>Deliverables:</strong> Create deliverables for your product area (for example
                                competitive analyses, user flows, low fidelity wireframes, high fidelity mockups,
                                prototypes, etc.) that solve real user problems through
                                the user experience.
                            </p>
                            <p><strong>Communication:</strong> Communicate the results of UX activities within your
                                product area to the design team department, cross-functional partners within your
                                product area, and other interested Superformula team
                        ...
                        <div class="sidebar-border">
                            <div class="sidebar-heading">
                                <div class="avatar-sidebar">
                                    <figure><img alt="jobBox" src="{{asset('assets/imgs/page/job-single/avatar.png')}}">
                                    </figure>
                                    <div class="sidebar-info"><span class="sidebar-company">AliThemes</span><span
                                            class="card-location">New York, US</span><a class="link-underline mt-15"
                                                                                        href="#">02 Open Jobs</a></div>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-list-job">
                                <ul>
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-1.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-2.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-3.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-4.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-5.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src={{asset('"assets/imgs/brands/brand-6.')}}png" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-7.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                    ...
                                    <li>
                                        <div class="card-list-4 wow animate__animated animate__fadeIn hover-up">
                                            <div class="image"><a href="job-details.html"><img
                                                        src="{{asset('assets/imgs/brands/brand-8.png')}}" alt="jobBox"></a>
                                            </div>
                                            <div class="info-text">
                                                <h5 class="font-md font-bold color-brand-1"><a href="job-details.html">UI
                                                        / UX Designer</a></h5>
                            ...
                            <div class="swiper-wrapper pb-10 pt-5">
                                    ...
                                    <div class="card-grid-2 hover-up">
                                        <div class="card-grid-2-image-left"><span class="flash"></span>
                                            <div class="image-box"><img
                                                    src="{{asset('assets/imgs/brands/brand-6.png')}}" alt="jobBox">
                                            </div>
                                            ...
                                            <div class="card-2-bottom mt-30">
                                                <div class="row">
                                                    <div class="col-lg-7 col-7"><span
                                                            class="card-text-price">$800</span><span class="text-muted">/Hour</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card-grid-2 hover-up">
                                        <div class="card-grid-2-image-left"><span class="flash"></span>
                                            <div class="image-box"><img
                                                    src="{{asset('assets/imgs/brands/brand-4.png')}}" alt="jobBox">
                                            </div>
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="card-2-bottom mt-30">
                                                <div class="row">
                                                    <div class="col-lg-7 col-7"><span
                                                            class="card-text-price">$250</span><span class="text-muted">/Hour</span>
                                                    </div>
                                                    <div class="col-lg-5 col-5 text-end">
                                                        <div class="btn btn-apply-now" data-bs-toggle="modal"
                                                             data-bs-target="#ModalApplyJobForm">Apply now
                                ...
                                <div class="swiper-slide">
                                    <div class="card-grid-2 hover-up">
                                        <div class="card-grid-2-image-left"><span class="flash"></span>
                                            <div class="image-box"><img
                                                    src="{{asset('assets/imgs/brands/brand-8.png')}}" alt="jobBox">
                                            </div>
